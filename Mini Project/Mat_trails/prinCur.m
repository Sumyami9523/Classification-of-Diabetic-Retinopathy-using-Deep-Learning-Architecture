...
% Image : Input Image
% Here we obtain parameters for Hessian metrx in every pixel and 
% find eigen values of the hessian matrix using lamdafind function
...
for r = 1:row
    for c = 1:col
        [lamdaplus(r,c),lamdaminus(r,c)]=lamdafind(gaa(r,c),gbb(r,c),gab(r,c)); 
    end
end
lamda2 = lamdaplus;
end